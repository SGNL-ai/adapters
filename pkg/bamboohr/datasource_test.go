...
func TestParseResponse(t *testing.T) {
	tests := map[string]struct {
		...
		"invalid_requested_int_type_conversion": {
			...
			wantErr: &framework.Error{
				Message: "Failed to parse attribute: supervisorEmail, as type Int64 with value: jcaldwell@efficientoffice.com.",
			...
			wantObjects: []map[string]any{
				{
					...
					"list2":                 []any{int64(1), nil, nil, int64(2)},
				},
				{
					"id":                    "5",
					"bestEmail":             "aadams@efficientoffice.com",
					...
					"supervisorEmail":       "jcaldwell@efficientoffice.com",
					"lastChanged":           "2024-04-12T19:33:50+00:00",
					"list2":                 []any{int64(33), nil, int64(2)},
				},
			},
			wantNextCursor: nil,
		},
			...
			wantObjects: []map[string]any{
				{
					...
					"supervisorEmail":       "jcaldwell@efficientoffice.com",
					"lastChanged":           "2024-04-12T19:33:50+00:00",
					"intList":               []any{int64(1), int64(2), int64(3), nil},
				},
				{
					"id":                    "5",
					"bestEmail":             "aadams@efficientoffice.com",
		...
		"invalid_int_list_conversion": {
			...
			wantErr: &framework.Error{
				Message: "Failed to parse attribute: boolList, as type Int64 with value: true.",
				Code:    adapter_api_v1.ErrorCode_ERROR_CODE_INVALID_ATTRIBUTE_TYPE,
			},
			wantNextCursor: nil,
		},
