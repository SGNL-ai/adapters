...
Group members are ingested as child entities and a relationship is to be created between the
child entity and the parent entity to allow traversal in snippets.
*/
package scim
