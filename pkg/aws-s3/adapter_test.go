	...
	tests := map[string]struct {
		...
		"error_object_moved_before_GetObject_HeadObject_200_GetObject_301": {
			...
			wantResponse: framework.Response{
				Error: &framework.Error{
					// nolint: lll
					Message: "Failed to fetch entity from AWS S3: customers, error: unable to read CSV file: failed to convert response: operation error S3: GetObject, http response error StatusCode: 301, permanent redirect: The bucket you are attempting to access must be addressed using the specified endpoint.",
					Code:    api_adapter_v1.ErrorCode_ERROR_CODE_INTERNAL,
				},
			},
		},
		"error_no_permission_to_GetObject_HeadObject_200_GetObject_403": {
			...
			wantResponse: framework.Response{
				Error: &framework.Error{
					// nolint: lll
					Message: "Failed to fetch entity from AWS S3: customers, error: unable to read CSV file: failed to convert response: operation error S3: GetObject, http response error StatusCode: 403, access denied: Access Denied.",
					Code:    api_adapter_v1.ErrorCode_ERROR_CODE_INTERNAL,
				},
			},
		},
		"error_object_deleted_after_HeadObject_and_before_GetObject_HeadObject_200_GetObject_403": {
			...
			wantResponse: framework.Response{
				Error: &framework.Error{
					// nolint: lll
					Message: "Failed to fetch entity from AWS S3: customers, error: unable to read CSV file: failed to convert response: operation error S3: GetObject, http response error StatusCode: 404, no such key: The specified key does not exist.",
					Code:    api_adapter_v1.ErrorCode_ERROR_CODE_INTERNAL,
				},
			},
		},
